...
class CreateCryptoDocumentsKeyCreateTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('crypto_documents_key_create', function (Blueprint $table) {
            $table->increments('id');
            $table->date('date');
    ...
    {
        Schema::dropIfExists('crypto_documents_key_create');
    }
}
