...
@section('content')
    ...
    @forelse($articles as $article)
        <div class="card mb-3">
            ...
            <div class="card-footer text-muted">
                <span class="mr-1" title="{{ __('knowledge/category.news_author') }}"><i class="fas fa-user"></i> {{ $article->last_name.' '.$article->first_name.' '.$article->middle_name }}</span>
    ...
    @empty
        <p>{{ __('knowledge/category.no_news') }}</p>
    @endforelse
