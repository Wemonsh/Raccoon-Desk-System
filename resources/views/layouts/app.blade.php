                    ...
                    <div class="col-3">
                        @section('sidebar')
                            <div class="list-group list-group-flush">
                                ...
                                <a href="{{ route('crypto') }}" class="list-group-item list-group-item-action">СКЗИ</a>
                                <a href="#" class="list-group-item list-group-item-action">Инвентаризация</a>
                                <a href="#" class="list-group-item list-group-item-action">Другое</a>
                            </div>
                        @show
                    </div>
                    <div class="col-9">
