...
@section('content')
    ...
    <div class="row">
        ...
        <div class="col-3">
            ...
            <div class="list-group">
                <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-chart-area fa-fw"></i> Поступишее имущество</a>
                <a href="#" class="list-group-item list-group-item-action"><i class="fas fa-chart-area fa-fw"></i> Списанное имущество</a>
