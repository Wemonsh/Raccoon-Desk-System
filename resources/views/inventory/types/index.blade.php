...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Типы МТС</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    ...
    <hr>
    <div class="toolbar">
        <a class="btn btn-secondary text-light" href="{{ route('typesCreate') }}">Добавить</a>
    </div>
    <table
        ...
        <tr>
            ...
            <th data-field="properties">Особенности</th>
    ...
    <script>
        ...
        function ajaxRequest(params) {
            var url = '/inventory/types/api-response';
        ...
        function actionFormatter(value ,rows) {
            return '<div class="btn-group" role="group" aria-label="Basic example">' +
                '<a class="btn btn-secondary btn-sm text-light" href="/inventory/types/edit/'+ rows['id'] +'" title="Редактировать"><i class="fas fa-pen"></i></a>' +
