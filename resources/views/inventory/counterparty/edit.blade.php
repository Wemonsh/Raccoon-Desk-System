...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-3">
            ...
            <li class="breadcrumb-item"><a href="{{ route('counterpartyIndex') }}">Контрагенты</a></li>
            <li class="breadcrumb-item active" aria-current="page">Редактировать контрагента</li>
        </ol>
    </nav>
@endsection
