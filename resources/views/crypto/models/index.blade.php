...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb mt-3">
            ...
            <li class="breadcrumb-item active" aria-current="page">Модели СКЗИ</li>
        </ol>
    </nav>
@endsection
...
@section('content')
    ...
    <hr>
    <div class="toolbar">
        <a class="btn btn-secondary text-light" href="{{ route('cryptoMcpiModelsCreate') }}">Добавить</a>
    </div>
    <table
        ...
        <tr>
            ...
            <th data-field="reg_number">Регистрационный номер</th>
            <th data-field="information">Информация</th>
